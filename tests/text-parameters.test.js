        ...
        test('includeTextColor: true - should handle special fill cases', () => {
            ...
            specialFillCases.forEach(({ description, fills, shouldIncludeColor }) => {
                ...
                if (shouldIncludeColor) {
                    expect((_a = fills === null || fills === void 0 ? void 0 : fills[0]) === null || _a === void 0 ? void 0 : _a.type).toBe('SOLID');
                    expect((_b = fills === null || fills === void 0 ? void 0 : fills[0]) === null || _b === void 0 ? void 0 : _b.visible).toBe(true);
                }
                else {
