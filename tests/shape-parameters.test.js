...
describe('Shape Parameter Tests', () => {
    ...
    describe('includeCornerRadius parameter', () => {
        ...
        test('includeCornerRadius: true - should handle mixed corner radius', () => {
            const mixedRadiusNode = Object.assign(Object.assign({}, mockRectangleNode({})), { cornerRadius: {}, topLeftRadius: 4, topRightRadius: 8, bottomRightRadius: 4, bottomLeftRadius: 8 });
