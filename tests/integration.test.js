...
describe('Plugin Integration Tests', () => {
    ...
    const mockComponentNode = (options = {}) => ({
        type: 'COMPONENT',
    ...
    describe('Complete Settings Combinations', () => {
        test('All settings enabled - maximum verbosity', () => {
            const maxSettings = Object.assign({}, DEFAULT_SETTINGS);
            const testScenarios = [
                {
    ...
    describe('Node Type Processing Priority', () => {
        test('Text nodes processing with various settings', () => {
            const textVariations = [
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useTextContent: true, includeTextColor: false }),
                    node: mockTextNode({ characters: 'Login' }),
                    expectedPriority: 'text content only'
                },
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useTextContent: false, includeTextColor: true }),
                    node: mockTextNode({
                        characters: 'Login',
                ...
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { enableTextLayers: false }),
        ...
        test('Shape nodes processing with various settings', () => {
            const shapeVariations = [
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { includeShapeType: true, includeFillColor: false }),
                    node: mockRectangleNode({}),
                    expectedPriority: 'type only'
                },
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { includeShapeType: false, includeFillColor: true }),
                    node: mockRectangleNode({
                ...
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { enableFigures: false }),
        ...
        test('Container nodes processing with various settings', () => {
            const containerVariations = [
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useFirstTextContent: true, includeContainerType: false }),
                    node: mockFrameNode({
                ...
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useFirstTextContent: false, includeContainerType: true }),
                    node: mockFrameNode({}),
                    expectedPriority: 'type only'
                },
                {
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { enableContainers: false }),
    ...
    describe('Complex Hierarchical Scenarios', () => {
            ...
            const nestedScenarios = [
                {
                    ...
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useFirstTextContent: true, useAutoLayoutNames: true }),
                ...
                },
                {
                    ...
                    settings: Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useAutoLayoutNames: true }),
                    expectation: 'should extract header from children'
                }
            ];
            nestedScenarios.forEach(({ name, structure, settings, expectation }) => {
                const childContainers = structure.children.filter((child) => child.type === 'FRAME' || child.type === 'GROUP');
        ...
        test('Mixed node types in containers', () => {
            ...
            mixedContentScenarios.forEach(({ name, container, expectedHeaderText }) => {
                const textNodes = container.children.filter((child) => child.type === 'TEXT');
    ...
    describe('Component Handling', () => {
        test('Components should be skipped in renaming', () => {
            const componentScenarios = [
                ...
                {
                    type: 'COMPONENT_SET',
                    node: Object.assign(Object.assign({}, mockComponentNode({ name: 'Button Set' })), { type: 'COMPONENT_SET' }),
                    shouldRename: false
                },
                {
                    type: 'INSTANCE',
                    node: Object.assign(Object.assign({}, mockComponentNode({ name: 'Button Instance' })), { type: 'INSTANCE' }),
                    shouldRename: false
                }
            ];
        ...
        test('Component recursion - should process children but not component itself', () => {
            ...
            const nonComponentChildren = componentWithChildren.children.filter((child) => !['COMPONENT', 'COMPONENT_SET', 'INSTANCE'].includes(child.type));
            ...
            const malformedNodes = [
                {
                    ...
                    node: Object.assign(Object.assign({}, mockTextNode({})), { characters: null }),
                    shouldHandle: true
                },
                {
                    name: 'shape with undefined fills',
                    node: Object.assign(Object.assign({}, mockRectangleNode({})), { fills: undefined }),
                    shouldHandle: true
                },
                {
                    name: 'container with null children',
                    node: Object.assign(Object.assign({}, mockFrameNode({})), { children: null }),
                    shouldHandle: true
                },
                {
        ...
        test('Extreme values should be handled', () => {
            ...
            extremeValueCases.forEach(({ name, node, expectedHandling }) => {
                ...
                if (name === 'very large dimensions') {
                    expect(node.width).toBe(999999);
                    expect(node.height).toBe(999999);
                }
    ...
    describe('Performance and Scalability', () => {
        ...
        test('Deep nesting performance', () => {
            ...
            let deeplyNested = mockTextNode({ characters: 'Deep Text' });
            for (let i = 0; i < 10; i++) {
