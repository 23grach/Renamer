...
describe('All Text Layer Parameters', () => {
    ...
    test.each(textCombinations)('Text parameter: $expectedBehavior', async (_a) => {
        var { expectedBehavior } = _a, setting = __rest(_a, ["expectedBehavior"]);
        ...
        const settings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), setting);
        // Mock style response
...
describe('All Shape Parameters', () => {
    ...
    test.each(shapeCombinations)('Shape parameter: $expectedBehavior', async (_a) => {
        var { expectedBehavior } = _a, setting = __rest(_a, ["expectedBehavior"]);
...
describe('All Container Parameters', () => {
    ...
    test.each(containerCombinations)('Container parameter: $expectedBehavior', async (_a) => {
        var { expectedBehavior } = _a, setting = __rest(_a, ["expectedBehavior"]);
...
describe('Edge Cases and Error Handling', () => {
    ...
    test('Mixed corner radius should handle gracefully', () => {
        const mixedRadiusNode = Object.assign(Object.assign({}, createMockRectangleNode({})), { cornerRadius: {}, topLeftRadius: 4, topRightRadius: 8, bottomRightRadius: 4, bottomLeftRadius: 8 });
...
describe('Plugin Integration Scenarios', () => {
    ...
    test('Settings save and load should work', async () => {
        const customSettings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), { useTextContent: false });
